...
local function setRTXData(dataStr)
...
local function createEditorHUD()
...
-- helper funcs-------
local function pointOverlaps(obj, mouseX, mouseY)
...
local function updateEditor(elapsed)
...
local function updateShader() -- update shader from slider stored values
	...
	setShaderFloat('boyfriend', 'innerShadowAngle', sliders[13][2] * to_rad)
