...
enum abstract RatingType(ByteInt) {
	var None;
	var Shit;
	var Bad;
	var Good;
	...
	public function toString() {
		return switch (cast (this, RatingType)) {
			case None: 'unknown';
			case Shit: 'shit';
			case Bad: 'bad';
			case Good: 'good';
...
class Note extends FlxSprite {
	...
	private static var pixelInt:Array<ByteInt> = [0, 1, 2, 3];

	// Lua shit
	public var noteSplashDisabled:Bool = false;
	public var noteSplashTexture:String = null;
	public var noteSplashHue:Single = 0;
	public var noteSplashSat:Single = 0;
	public var noteSplashBrt:Single = 0;
	...
	public var rating:RatingType = None;
