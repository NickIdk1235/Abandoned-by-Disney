...
Lib.application.window.title = "FNF: Abandoned by Disney - Options [Adjust Delay and Combo]";
	...
	override public function update(elapsed:Float) {
		...
		if (controls.BACK) {
			...
			FlxG.sound.playMusic(Paths.music('Hallucinations_By_IronCthulhuApocalypse'), 1, true);
