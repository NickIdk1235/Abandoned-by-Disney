...
class ControlsSubState extends MusicBeatSubstate {
	...
	var optionShit:Array<Dynamic> = [
		['NOTES'], ['Left', 'note_left'], ['Down', 'note_down'], ['Up', 'note_up'], ['Right', 'note_right'], [''], ['UI'], ['Left', 'ui_left'], ['Down', 'ui_down'], ['Up', 'ui_up'], ['Right', 'ui_right'], [''], ['Reset', 'reset'], ['Accept', 'accept'], ['Back', 'back'], ['Pause', 'pause'], [''], ['VOLUME'], ['Mute', 'volume_mute'], ['Up', 'volume_up'], ['Down', 'volume_down']];
	...
	public function new() {
		...
		Lib.application.window.title = "FNF: Abandoned by Disney - Options [Controls]";

		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('MantainanceBG'));
		// bg.color = 0xFFea71fd;
		bg.screenCenter();
